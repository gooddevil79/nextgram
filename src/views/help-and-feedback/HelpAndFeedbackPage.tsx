...
export const HelpAndFeedbackPage = function () {
  const items = [
    {
  ...
  return (
    <div>
      <Accordion isCompact selectionMode="single" variant="bordered">
        {items.map((itm) => (
          <AccordionItem
            key={itm.title}
      ...
      <div className="mx-auto my-5 flex max-w-5xl flex-col items-center justify-center space-y-2 text-center">
